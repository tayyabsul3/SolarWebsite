...
const Commercial = () => {
  const content = {
    p1: "Reduce your business’s exposure to rapidly-rising electricity tariffs by switching to a commercial solar system.Save up to 100% on Your Electricity Bills Through Hyper Solar’s tailored Commercial Solar Systems.",
